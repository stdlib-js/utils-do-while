...
[test-image]: https://github.com/stdlib-js/utils-do-while/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/utils-do-while/actions/workflows/test.yml?query=branch:v0.1.1
